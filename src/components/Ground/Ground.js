...
const Ground = () => {
    ...
    marbleMap = useMemo(() => new THREE.TextureLoader().load("/the-gallery/assets/Textures/BazaltMarble/BAZALT-diffuse.jpg"), []);
    marbleMap.wrapS = THREE.MirroredRepeatWrapping;
    marbleMap.wrapT = THREE.MirroredRepeatWrapping;
    marbleMap.repeat.set(size, size);

    marbleAlphaMap = useMemo(() => new THREE.TextureLoader().load("/the-gallery/assets/Textures/BazaltMarble/BAZALT-ao.jpg"), []);
    ...
    marbleNormalMap = useMemo(() => new THREE.TextureLoader().load("/the-gallery/assets/Textures/BazaltMarble/BAZALT-normal.jpg"), []);
    ...
    grassMap = useMemo(() => new THREE.TextureLoader().load("/the-gallery/assets/Textures/Grass/GrassGreenTexture0002.jpg"), []);
    ...
    return (
        <>
            ...
            <mesh ref={ref} receiveShadow>
                <planeBufferGeometry attach="geometry" args={[120, 185]} />
